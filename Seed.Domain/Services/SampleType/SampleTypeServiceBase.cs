...
namespace Seed.Domain.Services
{
    public class SampleTypeServiceBase : ServiceBase<SampleType>
    {
        ...
        protected readonly IValidatorSpecification<SampleType> _validation;
        protected readonly IWarningSpecification<SampleType> _warning;
        ...
        {
            this._validationResult  = this._validationResult.Merge(this._validation.Validate(sampletype));
			this._validationWarning  = this._validationWarning.Merge(this._warning.Validate(sampletype));
        }
